...
test('renders a number input with a label "Favorite Number"', () => {
  ...
  expect(queries.getByLabelText('Favorite Number')).toHaveAttribute(
    'type',
    'number',
  )
})
...
/*
http://ws.kcd.im/?ws=react-testing-library-course&e=dom-testing-library&em=aurimasdarguzis@gmail.com
*/
